...
userRouter.get('/', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (autHeader) {
            ...
            const loadedUser = yield UserRecord.getByEmail(decodedToken.userEmail);
...
userRouter.post('/login', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const token = jsonwebtoken.sign({ userEmail: loadedUser.email }, 'ldzAxLmvinv5whm2kgDvPjf7C5m9ngeq1298jdPArNc7lcNyiXxavKXVWi7bD9X', { expiresIn: '1h' });
    ...
    try {
        if (autHeader) {
            ...
            const ok = req.body.block
                ...
                : yield UserRecord.unblock(req.body.ids);
            res.json({ ok });
        }
        else {
            res.status(401).end();
